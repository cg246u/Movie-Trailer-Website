...
zoolander = media.Movie("Zoolander",
                        "A not so bright male model tasked to save the Prime Minister",
...
blindside = media.Movie("The Blindside",
                        "The story of an adopted African-American foster teenager who becomes a successful NFL player",
...
ironman = media.Movie("Iron Man",
                      "Story of Tony Stark played by Robert Downey Jr. as Marvel's Iron Man Superhero",
                      "https://upload.wikimedia.org/wikipedia/en/7/70/Ironmanposter.JPG",
                      "https://www.youtube.com/watch?v=KAE5ymVLmZg")

rascals = media.Movie("The Little Rascals",
                      "A comedy based on a group of neighborhood children and their attempt to win a race car derby",
...
monsters = media.Movie("Monster's Inc.",
                       "Pixar's child-friendly story of a monster world powered by the screams of children",
